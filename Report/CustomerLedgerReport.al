report 50101 "Customer Ledger Report"
{
    ...
    rendering
    {
        layout(CustLedgerReport)
        {
            ...
            LayoutFile = 'Report/CustomerLedgerReport.rdl'; // The name of the rdl report file that will be created once package is created. 
        }
